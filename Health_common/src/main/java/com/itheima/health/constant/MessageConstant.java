...
public class MessageConstant {
    ...
    public static final String CHECKITEM_ISCONNENCT = "当前检查项被引用，不能删除";
    ...
    public static final String IMPORT_ORDERSETTING_FAIL_NULL = "批量导入预约设置数据失败,文件无内容";
    ...
    public static final String QUERY_MENUE_SUCCESS = "查询菜单列表成功";
    public static final String QUERY_MENUE_FAIL = "查询菜单列表失败";
    public static final String ADD_MENUE_SUCCESS = "增加菜单项成功";
    public static final String ADD_MENUE_FAIL = "增加菜单项失败";
    public static final String DELETE_MENUE_SUCCESS = "删除菜单项成功";
    public static final String DELETE_MENUE_FAIL = "删除菜单项失败";
    ...
    public static final String QUERY_PERMISSION_SUCCESS= "查询权限列表数据成功";
    public static final String QUERY_PERMISSION_FAIL= "查询权限列表数据失败";
    ...
    public static final String QUERY_USERLIST_SUCCESS= "查询用户列表信息成功";
    public static final String QUERY_USERLIST_FAIL= "查询用户列表信息失败";
    public static final String ADD_USER_SUCCESS= "新增用户信息成功";
    public static final String ADD_USER_FAIL= "新增用户信息失败";
    ...
    public static final String DELETE_USER_SUCCESS= "删除角色信息成功";
    public static final String DELETE_USER_FAIL= "删除角色信息失败";
    public static final String SYSTEME_RROR= "服务器异常";
